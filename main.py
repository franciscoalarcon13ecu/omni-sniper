...
def ejecutar_sniper():
    ...
    enviar_a_discord("🎯 Sniper Conectado", "Sistema listo y enviando a ApuestasDeportivas2", 3066993)
        ...
        try:
            ...
            with InfluxDBClient(url=URL, token=TOKEN, org=ORG) as client:
                ...
                for p in partidos:
                    ...
                    # Simulación de probabilidad para visualización
                    prob_val = 85.0 if "City" in match_name or "Real" in match_name else 45.0
                ...
                print(f"✅ Ciclo: {enviados} partidos enviados a {BUCKET}.", flush=True)
            time.sleep(900)
